...
class AgentPageTests(InitializedWebTestCase):
    ...
    def test_agent_history_mobile_and_accessibility_contracts(self):
        ...
        self.assertIn("renderConfirmation(payload.confirmation, payload.tool_call, payload)", source)
        ...
        self.assertIn("确认票据已失效，请重新提交原任务生成新的预检", source)
