...
def summarize_guangya_capabilities(_arguments: dict[str, Any]) -> ToolResult:
    return ToolResult(
        ...
        data={
            ...
            "permanent_delete_policy": "full_recycle_snapshot_then_danger_confirm",
            "opaque_references": True,
            "raw_sdk_exposed": False,
            "agent_disabled_operations": ["local_upload"],
            ...
            "excluded_sensitive_capabilities": [
                ...
                "raw_delete_by_provider_id",
                "arbitrary_local_file_access",
                "raw_oss_request",
            ],
        },
        evidence=[
        ...
        suggestions=[
            ...
            "改名、移动、复制、回收、恢复、分享与清空回收站都必须先生成冻结计划。",
        ],
    )
